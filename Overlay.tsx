...
import { Mouse, Hand, ImagePlus, Music, VolumeX, HardDrive } from 'lucide-react';
      ...
      <div className="flex justify-between items-end pointer-events-auto w-full">
         <div className="flex gap-4">
            ...
            <button 
                ...
                className="bg-[#4285F4]/20 hover:bg-[#4285F4]/40 text-white backdrop-blur-md border border-[#4285F4]/30 px-6 py-3 rounded-lg flex items-center gap-2 transition-all hover:scale-105 active:scale-95 shadow-lg"
            >
